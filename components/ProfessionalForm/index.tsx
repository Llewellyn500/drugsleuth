...
const ProfessionalForm: React.FC = () => {
  return (
    <div>
      <h3 className="text-xl font-bold mb-4">Medical Professional Form</h3>
      {/* Add your form fields here */}
      <form>
        <div className="mb-4">
          <label htmlFor="license" className="block text-left">License Number</label>
          <input type="text" id="license" className="w-full p-2 border rounded" />
        </div>
        <div className="mb-4">
          <label htmlFor="specialty" className="block text-left">Specialty</label>
          <input type="text" id="specialty" className="w-full p-2 border rounded" />
        </div>
